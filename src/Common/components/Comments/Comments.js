...
import { Typo14DarkBlueGreyHKGroteskSemiBold,Typo16BrightBlueHKGroteskBold, Typo14SteelHKGroteskRegular, Typo18DarkBlueGreyHKGroteskMedium, Typo12DarkBlueGreyHKGroteskRegular } from "../../../../Common/style_guide/Typos";
        ...
        <Div>
            <Header>
                ...
                <Typo14DarkBlueGreyHKGroteskSemiBold>
                    {authorName} . <Typo14SteelHKGroteskRegular>. {commentDateAndTime}</Typo14SteelHKGroteskRegular>
                </Typo14DarkBlueGreyHKGroteskSemiBold>
            </Header>
            ...
            <Footer hasAnswer={answer?true:false}>
                ...
                <Div>
                    <ReactionAndComments>
                        <AiOutlineHeart color={hasReacted?"red":""}/>{reactions}  <ImageElement src="https://cdn.zeplin.io/5d0afc9102b7fa56760995cc/assets/e185f501-5dde-45ad-9f10-0cbeea737ee4.svg"/>{comments}
                    </ReactionAndComments>
                </Div>
            </Footer>
