...
class MenuTypeRequests extends Component{
    ...
    displayRequests=()=>{
        const {requestsList} = this.props;
       return <PendingRequestsTypeList onClickSeeAll={this.onClickSeeAll}limit={this.limit} shouldShowAll={this.shouldShowAll} requestsList={requestsList}/>
    }
render(){
        ...
        <Div>
            <Button onClick={onToggle}>
                ...
                <Span>
                    ...
                    <ToggleButton>{toggleStatus?<IoIosArrowDown onClick={onToggle}/>:<IoIosArrowUp onClick={onToggle}/>}</ToggleButton>
                </Span>
            </Button>
